/*
* @Author: dretrtg
* @Date:   2019-02-11 18:49:48
* @Last Modified by:   dretrtg
* @Last Modified time: 2019-04-04 20:04:53
*/
                    ...
                    <ul className="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul className="nav nav-second-level collapse in">
                                <li>
                                    <Link to="/gabage" activeClassName="active">商品管理</Link>
                                </li>
                                <li>
                                    <Link to="/gabage.category" activeClassName="active">品类管理</Link>
                                </li>
                            </ul>
                        </li>
                        <li>
